...
public class NtcEmpBbsController {
	...
	/**
	 * 공지사항 게시판 정보를 가져오는 컨트롤러
	 * @param model
	 * @param principal
	 * @return 공지사항 게시판 홈("board/ntcEmpBoardList")
	 */
	 ...
	 * @param model
	 * @param principal
	 * @return 공지사항 상세보기 페이지 ("board/ntcEmpBoardDetail")
	 */
	 ...
	 * 게시글 작성하는 컨트롤러
	 * @param model
	 * @return 게시글 작성 페이지("board/ntcEmpBoardCreate")
	 */
	 ...
	 * @param principal
	 * @param mav
	 * @return 점주 공지사항 게시판 페이지 ("/employee/ntcEmpBoardList")
	 */
	 ...
	 * @param nbNo
	 * @param model
	 * @return 공지사항 수정 페이지 ("board/ntcEmpBoardUpdate")
	 */
	 ...
	 * @param model
	 * @param principal
	 * @return 공지사항 홈 페이지("employee/ntcEmpBoardList")
	 */
