...
public class NtcBbsController {
	...
	/**
	 * 공지사항 게시판 정보 가져오는 컨트롤러
	 * @param model
	 * @param principal
	 * @return 공지사항 게시판 페이지("board/ntcBoardList")
	 */
	 ...
	 * @param model
	 * @param principal
	 * @return 공지사항 상세보기 페이지("board/ntcBoardDetail")
	 */
	 ...
	 * 공지사항 작성하는 컨트롤러
	 * @param model
	 * @return 공지사항 작성 페이지("board/ntcBoardCreate")
	 */
	 ...
	 * @param principal
	 * @param mav
	 * @return 점주 공지사항 작성 페이지("frcowner/ntcBoardCreate")
	 */
	 ...
	 * @param nbNo
	 * @param model
	 * @return 수정 페이지("board/ntcBoardUpdate")
	 */
	 ...
	 * @param model
	 * @param principal
	 * @return 점주 공지사항 게시판("frcowner/ntcBoardList")
	 */
	 ...
	 * 공지사항 게시글 삭제하는 컨트롤러
	 * @param nbNo
	 * @return 공지사항 게시글 목록 페이지 ("frcowner/ntcBoardList")
	 */
