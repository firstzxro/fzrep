					...
					<div class="d-grid mb-3"></div>
						<c:choose>
							...
							<c:when test="${check.atrzlnDt ne null}">
								<button class="btn btn-dark approver-btn" type="button" id="printBtn" >다운로드</button>
								<button class="btn btn-link approver-btn" type="button"><a href="/eatrzt/eatrztHome">목록</a></button>
							</c:when>
							<c:otherwise>
								<!-- 결재자 버튼 -->
								...
								<button class="btn btn-dark approver-btn" type="button" id="printBtn">다운로드</button>
								<button class="btn btn-link approver-btn" type="button"><a href="/eatrzt/beforeApvBoxList">목록</a></button>
							</c:otherwise>
						</c:choose>
				</div><br/>
